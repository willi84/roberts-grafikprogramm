...
def cLine(obj,x1,y1,x2,y2,d,s,tK1,tK2):
    tags(obj,tagKS(tK1,tK2),obj.create_line(x1,y1,x2,y2,width=d,arrow=s))
...
def cOval(obj,x1,y1,x2,y2,fi,tK1,tK2):
    tags(obj,tagKS(tK1,tK2),obj.create_oval(x1,y1,x2,y2fill=fi))
...
def maleLinie(x1, y1, x2, y2, farbe, figur, name, tagArt):
    ...
    cLine(koord,farbe,None,[figur, name, tagArt])
    objektliste(figur)
